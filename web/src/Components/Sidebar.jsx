...
const Sidebar = ({ sidebarToggle, setSidebarToggle }) => {
  ...
  return (
    <div
      ...
      } fixed  top-0 left-0 w-64 h-full bg-gray-50 z-50 border-r border-[#ccc]  `}
    >
      ...
      <div className="flex flex-col">
        ...
        <ul className="flex flex-col gap-4 mx-4 text-[20px] text-[#2E2C36] mb-4">
          <li className="cursor-pointer" onClick={() => navigate("/revenue")}>
            My Account
          </li>
          <li className="cursor-pointer" onClick={() => navigate("/supliers")}>
            Supliers
          </li>
