    ...
    <div className="h-screen w-screen">
      ...
      <div className="bg-[#FF6F00] h-[375px] w-full flex flex-col justify-center items-center">
        <div className="flex justify-center items-center">
          <div className="flex bg-white rounded-sm sm:w-[670px] max-w-[620px] min-w-[300px]">
            <img
              src={location}
              alt="location-icon"
            ...
            <input
              ...
              className="h-[65px] w-full bg-white rounded-sm outline-none caret-gray-100 px-4"
            />
          </div>
        </div>
      ...
      <div className="mx-4 flex flex-col  md:mt-16"> 
         <p className="font-bold text-[#333333] mt-4 md:mt-0 ml-8 mb-4 ">search what you need</p>
         <div className="box grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 place-items-center lg:gap-3">
          ...
          </div><div className="flex flex-col justify-center gap-6 items-center bg-[#2162A1] h-[200px] w-[300px] rounded-3xl">
            <div className="mt-6 ">
              <img src={sport} alt="" />
            </div>
            <div className="bg-white h-full  w-full">
      ...
      <div className="flex  justify-center items-center md:text-7xl text-5xl font-medium mb-6">
        <p className="text-[#2E2C36] flex justify-center items-center">JOIN US <span className="text-[#FF6F00] flex justify-center items-center ml-2">NOW</span><span className="ml-2">!</span></p>
      </div>
      ...
      <div className="w-[340px] h-[410px] border border-[#003366] rounded-lg flex flex-col items-center  shadow-md">
       ...
       <p className="text-[#6A696E] text-[15px] leading-6 text-center">Discover the advantages of our <br /> partners in 20 wiliaya who are already <br /> working <br /> with Serbili.</p>
      ...
      <div className="w-[340px] h-[410px] border border-[#003366] rounded-lg flex flex-col items-center  shadow-md">
       ...
       <p className="text-[#6A696E] text-[15px] leading-6 text-center mt-5"> Access millions of serbili users and <br />benefit from immediate logistics without <br /> leave your store.</p>
       <button className="bg-[#E9FCF2] px-32 py-3 mt-5 text-[#003366] font-bold" >
        Sign in
       </button>
      </div>
      ...
      <div className="bg-orange-500  w-full mt-32 pb-32 pt-16">
       ...
       <p className="text-2xl leading-4 font-medium text-[#FFFFFF]">BRNADS THAT TRUST US</p>
      ...
      <div className="flex md:justify-between justify-center items-center ">
       <div className=" flex flex-col gap-6 ml-2 mt-16 md:mt-6 md:ml-4 lg:ml-20">
        <p className="font-bold lg:text-[40px] md:text-3xl text-2xl  lg:leading-10 sm:leading-8 max-md:text-center">We Make Sure That Your <br /> Products Will Reach You <br />Safely</p>
        <p className="text-xs lg:leading-7 sm:leading-5  max-md:mt-8 max-md:text-center">We make sure your product reaches you safely and securely. Our team handles <br className="max-md:hidden" /> ever package with care and precision.With reliable delivery services,we <br className="max-md:hidden" /> prioritize satisfaction . Trust us for a smouth <br className="md:hidden" /> and hassle-free experience!"</p>
       </div>
     ...
     <img src={privacy} alt="" />
     <p className="text-4xl leading-10 mt-8 max-md:text-center">Your privacy is our responsibility</p>
     <p className="text-[15px] text-[#333333] leading-7 mt-6 ">We believe that trust is paramount in a relationship . We do not own or sell your data , and we <br className="max-md:hidden"/>
    <span className="max-md:ml-2"> most certainly do not bank on advertising-based business models.The only way we make</span> <br className="max-md:hidden"  />
    <span className="md:flex justify-center  "> money is from the software license fees you pay us.</span></p>
      </div>
      <Footer/>
    </div>
  );
